...
-- Creang te the External Data Stage pointito the Azure Blob Container
...
-- 1. Change the user type to bypass mandatory human MFA
ALTER USER POWERBI SET TYPE = 'LEGACY_SERVICE';

-- 2. Explicitly disable the MFA requirement again
ALTER USER POWERBI SET DISABLE_MFA = TRUE;

-- 3. Just in case, give it a 7-day total bypass window
ALTER USER POWERBI SET MINS_TO_BYPASS_MFA = 10080;

-- 4. Confirm the password one last time
ALTER USER POWERBI SET PASSWORD = 'PowerBI_AVas_2026!';
